  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 text-white">
      ...
      <div className="pt-24 pb-20 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center text-center">
        <h1 className="text-4xl md:text-6xl font-bold mb-4">Welcome to Mazagan Screenverse</h1>
        <p className="text-xl md:text-2xl text-blue-200 max-w-3xl mb-8">
          Your premier destination for the latest movies and seamless ticket booking experience.
        </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-3xl font-bold mb-10 text-center">Featured Movies</h2>
        {loading ? (
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-8">
              {displayedMovies.length > 0 ? (
                displayedMovies.map((movie) => (
                  <Link to={`/showtimes/${movie.id}`} key={movie.id} className="movie-card group">
                    <div className="relative aspect-[2/3] overflow-hidden">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-4">
                        ...
                        <p className="text-sm text-gray-300">{movie.duration_minutes} mins</p>
                      </div>
                    </div>
                  </Link>
                ))
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-blue-200">Explore our selection of the latest blockbusters and timeless classics.</p>
            </div>
            <div className="text-center p-6">
              <div className="text-5xl mb-4 flex justify-center">🎟️</div>
              <h3 className="text-xl font-bold mb-2">Select Seats</h3>
              <p className="text-blue-200">Choose your preferred seats from our interactive seating chart.</p>
            </div>
            <div className="text-center p-6">
              <div className="text-5xl mb-4 flex justify-center">✅</div>
              <h3 className="text-xl font-bold mb-2">Confirm Booking</h3>
              <p className="text-blue-200">Complete your booking and receive instant confirmation.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-6 text-sm text-blue-400">
              © {new Date().getFullYear()} Mazagan SCREENVERSE. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
